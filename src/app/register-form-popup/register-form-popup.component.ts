...
@Component({
  ...
  styleUrl: './register-form-popup.component.css'
})
export class RegisterFormPopupComponent {
  ...
  onSubmit() {
    ...
    if (!this.contactForm.username || !this.contactForm.phonenumber || !this.contactForm.email || !this.contactForm.qualification) {
